...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.apache'] = new \phpbb\auth\provider\apache($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        return $this->services['auth.provider.db'] = new \phpbb\auth\provider\db($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), $this, '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        $this->services['avatar.driver.gravatar'] = $instance = new \phpbb\avatar\driver\gravatar($this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.local'] = $instance = new \phpbb\avatar\driver\local($this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.remote'] = $instance = new \phpbb\avatar\driver\remote($this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.upload'] = $instance = new \phpbb\avatar\driver\upload($this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('path_helper'), $this->get('mimetype.guesser'), $this->get('dispatcher'), $this->get('cache.driver'));
    ...
    {
        return $this->services['cache'] = new \phpbb\cache\service($this->get('cache.driver'), $this->get('config'), $this->get('dbal.conn'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        $this->services['class_loader'] = $instance = new \phpbb\class_loader('phpbb\\', '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/includes/', 'php');
    ...
    {
        $this->services['class_loader.ext'] = $instance = new \phpbb\class_loader('\\', '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/ext/', 'php');
    ...
    {
        return $this->services['console.command.db.migrate'] = new \phpbb\console\command\db\migrate($this->get('user'), $this->get('migrator'), $this->get('ext.manager'), $this->get('config'), $this->get('cache'), $this->get('log'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_forums', 'phpbb_posts', 'phpbb_topics', 'phpbb_users');
    }
    ...
    {
        return $this->services['controller.helper'] = new \phpbb\controller\helper($this->get('template'), $this->get('user'), $this->get('config'), $this->get('controller.provider'), $this->get('ext.manager'), $this->get('symfony_request'), $this->get('request'), $this->get('filesystem'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    protected function getController_ProviderService()
    {
        ...
        $instance->find('/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/');
    ...
    {
        return $this->services['controller.resolver'] = new \phpbb\controller\resolver($this->get('user'), $this, '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', $this->get('template'));
    }
    ...
    {
        return $this->services['cron.manager'] = new \phpbb\cron\manager($this->get('cron.task_collection'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        $this->services['cron.task.core.prune_all_forums'] = $instance = new \phpbb\cron\task\core\prune_all_forums('/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('config'), $this->get('dbal.conn'));
    ...
    {
        $this->services['cron.task.core.prune_forum'] = $instance = new \phpbb\cron\task\core\prune_forum('/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('config'), $this->get('dbal.conn'));
    ...
    {
        $this->services['cron.task.core.prune_shadow_topics'] = $instance = new \phpbb\cron\task\core\prune_shadow_topics('/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('config'), $this->get('dbal.conn'), $this->get('log'), $this->get('user'));
    ...
    {
        $this->services['cron.task.core.queue'] = $instance = new \phpbb\cron\task\core\queue('/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('config'));
    ...
    {
        $this->services['cron.task.core.tidy_database'] = $instance = new \phpbb\cron\task\core\tidy_database('/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('config'));
    ...
    {
        $this->services['cron.task.core.tidy_plupload'] = $instance = new \phpbb\cron\task\core\tidy_plupload('/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', $this->get('config'));
    ...
    {
        $this->services['cron.task.core.tidy_search'] = $instance = new \phpbb\cron\task\core\tidy_search('/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('dispatcher'));
    ...
    {
        $this->services['cron.task.core.tidy_warnings'] = $instance = new \phpbb\cron\task\core\tidy_warnings('/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('config'));
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('mysql12.citysites.se', '126139-ed12016', '57dWJ48iW9', '126139-bockbrannarbolmers', '', false, false);
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), $this->get('user'), 'phpbb_ext', '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['feed.helper'] = new \phpbb\feed\helper($this->get('config'), $this->get('user'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        return $this->services['hook_finder'] = new \phpbb\hook\finder('/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['kernel_request_subscriber'] = new \phpbb\event\kernel_request_subscriber($this->get('ext.manager'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'adm/', 'php', 'phpbb_log');
    }
    ...
    {
        return $this->services['message.form.admin'] = new \phpbb\message\admin_form($this->get('auth'), $this->get('config'), $this->get('config_text'), $this->get('dbal.conn'), $this->get('user'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        return $this->services['message.form.topic'] = new \phpbb\message\topic_form($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        return $this->services['message.form.user'] = new \phpbb\message\user_form($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'phpbb_migrations', '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_modules');
    }
    ...
    {
        return $this->services['migrator.tool.permission'] = new \phpbb\db\migration\tool\permission($this->get('dbal.conn'), $this->get('cache'), $this->get('auth'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\email($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\jabber($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        return new \phpbb\notification\type\admin_activate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\bookmark($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\quote($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }
    ...
    {
        return $this->services['passwords.driver.md5_phpbb2'] = new \phpbb\passwords\driver\md5_phpbb2($this->get('request'), $this->get('passwords.driver.salted_md5'), $this->get('passwords.driver_helper'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php');
    }
    ...
    {
        return $this->services['path_helper'] = new \phpbb\path_helper($this->get('symfony_request'), $this->get('filesystem'), $this->get('request'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'adm/');
    }
    ...
    {
        return $this->services['plupload'] = new \phpbb\plupload\plupload('/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', $this->get('config'), $this->get('request'), $this->get('user'), $this->get('php_ini'), $this->get('mimetype.guesser'));
    }
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/', 'php', 'phpbb_users');
    }
    ...
    {
        return array(
            'core.root_path' => '/www/webvol38/7e/uba0ybhsh0vubtm/bockbrannarbolmers.se/public_html/',
            'core.php_ext' => 'php',
            ...
            'dbal.dbhost' => 'mysql12.citysites.se',
            'dbal.dbuser' => '126139-ed12016',
            'dbal.dbpasswd' => '57dWJ48iW9',
            'dbal.dbname' => '126139-bockbrannarbolmers',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
