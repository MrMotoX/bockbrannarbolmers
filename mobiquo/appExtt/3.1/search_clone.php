...
global $phpbb_root_path, $phpEx, $cache,$phpbb_container,$phpbb_dispatcher, $searchResults, $mobiquo_config, $user, $auth, $db, $template, $request_method, $total_match_count;
