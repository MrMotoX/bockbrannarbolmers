...
class MbqStatus extends MbqBaseStatus
{
    ...
    protected function ResetBYOInfo()
    {
        ...
        $TT_connection = new classTTConnection();
        $TT_bannerControlData = $TT_connection->getForumInfo($board_url, $api_key);
        $cache->put('_tapatalk_banner_control',  $TT_bannerControlData);
        setTapatalkConfigValue('tapatalk_banner_control',  serialize($TT_bannerControlData));
